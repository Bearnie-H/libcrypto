...
extern const uint8_t AES_Test_Key_128_Expanded[sizeof(uint32_t) * AES_Block_128 * (AES_Round_10 + 1)];
extern const uint8_t AES_Test_Key_192_Expanded[sizeof(uint32_t) * AES_Block_128 * (AES_Round_12 + 1)];
extern const uint8_t AES_Test_Key_256_Expanded[sizeof(uint32_t) * AES_Block_128 * (AES_Round_14 + 1)];
