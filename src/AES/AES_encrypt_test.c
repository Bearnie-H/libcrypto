...
int Test_AES_Encrypt_Block_128(void) {
    ...
    if ( 0 != AES_Encrypt_Block(Context, AES_Test_Enc_InputVector, sizeof(AES_Test_Enc_InputVector), EncryptedVector) ) { 
    ...
    if ( 0 != memcmp(EncryptedVector, AES_Test_Dec_InputVector_128, sizeof(EncryptedVector)) ) {
        printf("Test_AES_Encrypt_Block_128() Failure: Encrypted vector does not match expected value!\n");
        AES_Context_Release(Context);
        return 1;
    }
...
int Test_AES_Encrypt_Block_192(void) {
    ...
    if ( 0 != memcmp(EncryptedVector, AES_Test_Dec_InputVector_192, sizeof(EncryptedVector)) ) {
        printf("Test_AES_Encrypt_Block_192() Failure: Encrypted vector does not match expected value!\n");
        AES_Context_Release(Context);
        return 1;
    }
...
int Test_AES_Encrypt_Block_256(void) {
    ...
    if ( 0 != memcmp(EncryptedVector, AES_Test_Dec_InputVector_256, sizeof(EncryptedVector)) ) {
        printf("Test_AES_Encrypt_Block_256() Failure: Encrypted vector does not match expected value!\n");
        AES_Context_Release(Context);
        return 1;
    }
