...
int Test_AES_SubBytes(void) {
    ...
    const uint8_t StartingVector[sizeof(uint32_t) * AES_Block_128] = {
        0x00, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 0xa0, 0xb0, 0xc0, 0xd0, 0xe0, 0xf0
    };

    const uint8_t EndingVector[sizeof(uint32_t) * AES_Block_128] = {
...
int Test_AES_ShiftRows(void) {
    ...
    const uint8_t StartingRows[sizeof(uint32_t) * AES_Block_128] = {
        0xd4, 0x27, 0x11, 0xae, 0xe0, 0xbf, 0x98, 0xf1, 0xb8, 0xb4, 0x5d, 0xe5, 0x1e, 0x41, 0x52, 0x30
    };

    const uint8_t EndingRows[sizeof(uint32_t) * AES_Block_128] = {
...
int Test_AES_MixColumns(void) {
    ...
    const uint8_t StartingColumns[sizeof(uint32_t) * AES_Block_128] = {
        0xd4, 0xbf, 0x5d, 0x30, 0xe0, 0xb4, 0x52, 0xae, 0xb8, 0x41, 0x11, 0xf1, 0x1e, 0x27, 0x98, 0xe5
    };

    const uint8_t EndingColumns[sizeof(uint32_t) * AES_Block_128] = {
...
int Test_AES_AddRoundKey(void) {
    ...
    const uint8_t KeySchedule[sizeof(uint32_t) * AES_Block_128] = {
