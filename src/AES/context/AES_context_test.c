...
int Test_AES_Context_Prepare_128(void) {
    ...
    AES_Context_t* Context = AES_Context_Prepare(AES_Block_128, AES_Key_128, AES_Test_Expansion_Key_128);
    if ( NULL == Context ) {
    ...
    if ( Context->BlockLength != AES_Block_128 ) {
        printf("Test_AES_Context_Prepare_128() Failure: Context block length not expected value!\n");
...
int Test_AES_Context_Prepare_192(void) {
    ...
    AES_Context_t* Context = AES_Context_Prepare(AES_Block_128, AES_Key_192, AES_Test_Expansion_Key_192);
    if ( NULL == Context ) {
    ...
    if ( Context->BlockLength != AES_Block_128 ) {
        printf("Test_AES_Context_Prepare_192() Failure: Context block length not expected value!\n");
        AES_Context_Release(Context);
        return 1;
    }
...
int Test_AES_Context_Prepare_256(void) {
    ...
    AES_Context_t* Context = AES_Context_Prepare(AES_Block_128, AES_Key_256, AES_Test_Expansion_Key_256);
    if ( NULL == Context ) {
    ...
    if ( Context->BlockLength != AES_Block_128 ) {
        printf("Test_AES_Context_Prepare_256() Failure: Context block length not expected value!\n");
        AES_Context_Release(Context);
        return 1;
    }
...
int Test_AES_KeyExpansion_128(void) {
    ...
    if ( 0 != AES_KeyExpansion(AES_Test_Expansion_Key_128, AES_Key_128, ExpandedKey, sizeof(ExpandedKey) / sizeof(uint32_t)) ) {
    ...
    if ( 0 != memcmp(ExpandedKey, AES_Test_Key_128_Expanded, sizeof(AES_Test_Key_128_Expanded)) ) {
        printf("Test_AES_KeyExpansion_128() Failure: Expanded Key does not match expected value!\n");
        return 1;
    }
...
int Test_AES_KeyExpansion_192(void) {
    ...
    if ( 0 != AES_KeyExpansion(AES_Test_Expansion_Key_192, AES_Key_192, ExpandedKey, sizeof(ExpandedKey) / sizeof(uint32_t)) ) {
    ...
    if ( 0 != memcmp(ExpandedKey, AES_Test_Key_192_Expanded, sizeof(AES_Test_Key_192_Expanded)) ) {
        printf("Test_AES_KeyExpansion_192() Failure: Expanded Key does not match expected value!\n");
        return 1;
    }
...
int Test_AES_KeyExpansion_256(void) {
    ...
    if ( 0 != AES_KeyExpansion(AES_Test_Expansion_Key_256, AES_Key_256, ExpandedKey, sizeof(ExpandedKey) / sizeof(uint32_t)) ) {
    ...
    if ( 0 != memcmp(ExpandedKey, AES_Test_Key_256_Expanded, sizeof(AES_Test_Key_256_Expanded)) ) {
        printf("Test_AES_KeyExpansion_256() Failure: Expanded Key does not match expected value!\n");
        return 1;
    }
